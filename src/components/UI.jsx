  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-between p-4 flex-col pointer-events-none">
        {/* Header Section */}
        <div className="self-start backdrop-blur-md bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 bg-opacity-80 p-4 rounded-lg shadow-md">
          <h1 className="font-black text-xl text-white">My Virtual Assistant</h1>
          <p className="text-white">Always here to assist you 💙</p>
        </div>
